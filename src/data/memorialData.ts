...
export const memorialData: MemorialData = {
  ...
  2007: {
    events: [
      ...
      { "tag": "gestao", "title": "Homenagem por Aposentadoria e Regimento Interno", "desc": "Entrega solene de placa de homenagem à professora Maria da Graça Nemer Jentzsch pela sua aposentadoria e aprovação unânime das alterações no Regimento Interno do Lato Sensu em Controladoria e Finanças. 17 de julho de 2007" },
  ...
  2008: {
    events: [
      { "tag": "extensao", "title": "Professor da Universidade de Valência visita a UFV e propõe parcerias com o Centev", "desc": "Durante a visita do Prof. Rafael Guerrero (Universidade de Valência) à UFV, motivada pelo convite do Prof. José Roberto Reis, discutiu-se a criação de um convênio focado no intercâmbio acadêmico e em programas de doutorado sanduíche. O docente espanhol reuniu-se com a diretoria do Agros para trocar experiências sobre modelos de gestão previdenciária e planos de saúde. Além disso, ele conheceu a Incubadora e o Parque Tecnológico do Centev/UFV, demonstrando forte interesse em consolidar parcerias na área de inovação e incubação de empresas. O encontro também abriu caminhos para a criação de uma rede internacional voltada à divulgação de pesquisas científicas globais. N 1.413" },
      { "tag": "extensao", "title": "Cace Consultoria Jr. apresenta workshop em encontro mundial de empresas juniores", "desc": "A Cace Consultoria Jr., empresa júnior de Administração da UFV, participou da 3ª Junior Enterprise World Conference na cidade de Porto, em Portugal. Representando a organização, as diretoras Elisa Baruffi e Romi Azevedo apresentaram um workshop focado em gestão do conhecimento e no Programa de Qualidade 5's. A apresentação contou com uma dinâmica prática que envolveu a análise de uma empresa fictícia por cerca de 300 empresários juniores mundiais. O evento propiciou uma rica troca de experiências sobre as diferenças entre os modelos de gestão aplicados por brasileiros e europeus. Há 15 anos no mercado, a empresa júnior presta serviços de consultoria corporativa de alta qualidade para micro, pequenas e médias empresas na Zona da Mata. N 1.417" },
  ...
  2009: {
    events: [
      ...
      { tag: 'gestao', title: 'Posse do Professor Luiz Antônio Abrantes', desc: 'O primeiro pró-reitor de Gestão de Pessoas da UFV, Luiz Antônio Abrantes, tomou posse em cerimônia realizada no dia 30 de dezembro. A criação do novo órgão foi oficializada pelo Conselho Universitário com o objetivo de valorizar os servidores e o capital intelectual da instituição. Em seu discurso, o professor destacou a importância de alinhar o respeito à legislação com a constante necessidade de mudança. Na mesma solenidade, o técnico Ely Rosa foi nomeado para assumir o cargo de diretor-assistente. Nº 1.421 (28 de fevereiro de 2009)' },
  ...
  2010: {
    events: [
      { "tag": "ensino", "title": "Orçamentos de Pós-Graduação e Criação do NUPEC", "desc": "16 de março de 2010 – Ata nº 274/2010. Nesta reunião, foi apresentado o orçamento do curso de pós-graduação Lato Sensu em Controladoria e Finanças, além da apreciação e aprovação do orçamento para o curso de pós-graduação Lato Sensu em Gestão Empresarial e Ambiental e do orçamento para o curso de pós-graduação Lato Sensu em Gestão Estratégica. Também foi formalizada a criação do Núcleo de Pesquisa em Contabilidade (NUPEC), voltado para a Iniciação Científica do curso de Ciências Contábeis, que já havia realizado o seu processo de seleção e aprovado alunos para receberem bolsas de estudo." },

      { "tag": "infraestrutura", "title": "Convênio Software com E & L e Semana Acadêmica", "desc": "13 de agosto de 2010 – Ata nº 275/2010 Durante a sessão, foi formalizada a proposta de assinatura de convênio entre a empresa E & L Produções de Software Ltda e a Universidade Federal de Viçosa, com o objetivo de realizar a implantação de um novo programa no laboratório de informática do DAD. Além disso, foi comunicada aos presentes a realização da futura Semana Acadêmica de Administração e Contabilidade, que ocorreria de forma conjunta com o Congresso de Gestão de Pessoas." },

      { "tag": "gestao", "title": "Visita do Reitor e Futuros Cursos", "desc": "12 de novembro de 2010 – Ata nº 278/2010 O Colegiado recebeu uma visita oficial do Magnífico Reitor e da Vice-Reitora da instituição, acompanhados pelo Diretor do Centro de Ciências Humanas, Letras e Artes. No encontro, discutiu-se o andamento do curso de Ciências Contábeis, cujas instâncias haviam aprovado o Projeto Pedagógico, e debateu-se a futura criação de uma graduação em Administração no horário diurno, bem como a inserção da área de Administração Pública na grade. Houve também relatos sobre a criação e o panorama do curso de pós-graduação em Administração Pública e o funcionamento do curso Lato Sensu em Controladoria e Finanças." },

      { "tag": "ensino", "title": "Nova Turma de Controladoria e Certificações", "desc": "10 de dezembro de 2010 – Ata nº 279/2010 Nesta data, o Colegiado aprovou o oferecimento de uma nova turma para o curso de pós-graduação Lato Sensu em Controladoria e Finanças, programada para o período de 2011/2013, que contou com uma readequação de sua grade curricular e alteração de ementas. Adicionalmente, foi aprovada a emissão de certificados para os alunos concluintes das turmas de 2008-2010 dos cursos de pós-graduação Lato Sensu em Gestão Estratégica e em Gestão e Diagnóstico Empresarial." },
      ...
      { tag: 'ensino', title: 'Perspectivas Atuais e Desempenho Acadêmico', desc: 'Atualmente, o CCH possui uma estrutura robusta com 11 departamentos e oferece 15 cursos de graduação, tendo registrado aproximadamente 33 mil matrículas em disciplinas no ano de 2009. Na pós-graduação, o centro consolidou cinco programas de mestrado stricto sensu em áreas estratégicas como Administração Pública, Políticas Públicas e Desenvolvimento Regional, Economia Familiar, Educação e Estudos Linguísticos e Literários. O corpo docente é composto por cerca de 190 professores, dos quais mais de 60% são doutores, refletindo um esforço contínuo de qualificação e contratação para atender à crescente demanda acadêmica e científica.' },
      { tag: 'extensao', title: 'Desafios em Pesquisa, Extensão e Infraestrutura', desc: 'Um dos principais desafios e metas do CCH é a consolidação de sua produção científica, que tem apresentado aumento no número de projetos financiados e publicações em revistas qualificadas, além da criação de espaços de integração como o Fórum de Pesquisa do CCH. Na extensão, o foco reside em fortalecer o diálogo com a comunidade regional, prevendo a criação de um fórum específico para debater ações nessa área. No âmbito da infraestrutura, projeta-se um crescimento físico de 150% com a construção de novos prédios para departamentos e coordenações, visando dar suporte ao desenvolvimento dos cursos pioneiros e à plena consolidação das novas graduações, criando para o CCH um espaço proporcional à sua relevância socioeconômica e cultural.' },
      { tag: 'ensino', title: 'Histórico e Relevância do Curso de Administração', desc: 'O curso de Administração da Universidade Federal de Viçosa celebrou seus 35 anos de fundação consolidando-se como uma referência na formação de profissionais capacitados para atuar em diversos setores da economia. Criado em 1975, o curso evoluiu significativamente ao longo das décadas, acompanhando as transformações do mercado e integrando-se ao Centro de Ciências Humanas, Letras e Artes (CCH). Durante a solenidade comemorativa, destacou-se a trajetória de excelência acadêmica e o papel fundamental do departamento na produção de conhecimento científico e na promoção de projetos de extensão que beneficiam a comunidade regional. Nº 1.434' },
      { tag: 'reconhecimento', title: 'Homenagens e Reconhecimento no Aniversário do Curso', desc: 'A cerimônia de aniversário foi marcada por homenagens a personagens ilustres que contribuíram para a construção da história do curso, incluindo ex-coordenadores, professores pioneiros e servidores técnico-administrativos. O evento contou com a presença de autoridades acadêmicas, como o reitor Luiz Cláudio Costa e o diretor do CCH, Walmer Faroni, que enfatizaram a maturidade alcançada pela graduação e o sucesso de seus egressos no cenário nacional. Além dos discursos protocolares, a celebração serviu como um momento de reencontro e reconhecimento do esforço coletivo que posicionou a Administração da UFV entre os cursos mais respeitados do país.' },
      { tag: 'reconhecimento', title: 'Excelência no Enade e Destaque do Curso de Administração', desc: 'O curso de Administração da UFV alcançou um resultado histórico ao obter a nota máxima 5 no Exame Nacional de Desempenho dos Estudantes (Enade) de 2009, consolidando sua posição entre os melhores do país. Esse desempenho de excelência reflete a qualidade do projeto pedagógico e o compromisso do corpo docente e discente com o ensino de alto nível, contribuindo para que o CCH mantivesse sua tradição de bons indicadores educacionais. Além da Administração, outros cursos do centro também apresentaram resultados expressivos, reforçando a importância da unidade na formação acadêmica de destaque dentro do cenário nacional das ciências humanas. Nº 1.436' },
      { tag: 'ensino', title: 'Consolidação e Expansão da Pós-Graduação', desc: 'A pós-graduação no CCH vive um período de forte crescimento e reconhecimento, com programas que se destacam pela produção científica e pela formação de mestres e doutores qualificados. A diversificação das áreas de pesquisa tem permitido ao centro atrair investimentos e parcerias estratégicas, ampliando o impacto social e acadêmico de suas investigações. Esse amadurecimento dos programas de pós-graduação é visto como um pilar essencial para a internacionalização do centro e para a melhoria contínua da graduação, gerando um ciclo virtuoso de inovação e excelência dentro da universidade.' },
      { tag: 'extensao', title: 'Participação em Eventos e Protagonismo de Ronan e Suely', desc: 'Os professores Ronan Eustáquio Borges e Suely de Fátima Ramos Silveira tiveram uma participação de destaque em eventos de relevância nacional, representando o CCH e o Departamento de Administração em debates fundamentais para a área. Através de apresentações de trabalhos e coordenação de mesas, os docentes contribuíram para a divulgação de pesquisas desenvolvidas na UFV, fortalecendo o intercâmbio de conhecimentos com outras instituições brasileiras. Essa atuação externa é fundamental para manter o centro conectado às principais tendências e desafios da administração pública e privada, elevando o prestígio acadêmico da instituição em fóruns científicos de grande visibilidade.' }
    ],
  ...
  2011: {
    events: [
      { "tag": "gestao", "title": "Nomeação de Professores e Infraestrutura Física", "desc": "Ata n.º 280/2011 (11 de fevereiro de 2011) Durante a reunião do Colegiado do Departamento de Administração e Contabilidade realizada no dia onze de fevereiro de dois mil e oitenta e um, o Senhor Presidente deu as boas-vindas oficiais à recém-chegada professora Fernanda Maria de Almeida na abertura dos trabalhos. No decorrer da sessão, dentro do espaço dedicado aos informes de interesse geral, o presidente anunciou uma medida de aprimoramento das instalações físicas da unidade por meio da compra de materiais específicos destinados à confecção e instalação de armários privativos nos gabinetes dos professores" },

      { "tag": "extensao", "title": "Extensão no Coluni e Café Comemorativo", "desc": "Ata n.º 282/2011 (7 de abril de 2011) No dia sete de abril de dois mil e onze, em reunião do Colegiado, o professor Rodrigo Gava apresentou o planejamento de uma ação de extensão focada em inovação tecnológica aplicada ao ensino médio, instituindo o Coluni como a organização piloto para o projeto. Posteriormente, na seção de assuntos diversos, o professor Wender Fraga Miranda informou oficialmente que a equipe do curso Lato Sensu ofereceria uma celebração festiva com café para homenagear os aniversariantes do mês de abril." },

      { "tag": "ensino", "title": "Criação do Bacharelado em Sistemas de Informação", "desc": " Ata n.º 283/2011 (17 de junho de 2011) Na sessão ordinária do Colegiado ocorrida em dezessete de junho de dois mil e onze, os conselheiros apreciaram e deliberaram de forma unânime a aprovação de uma deliberação urgente via ato ad referendum, ratificando formalmente a homologação do projeto institucional voltado à criação do novo curso de graduação em Bacharelado em Sistemas de Informação no Campus da UFV em Viçosa." },

      { "tag": "ensino", "title": "Andamento de Curso e Dia do Administrador", "desc": "Ata n.º 285/2011 (1 de setembro de 2011) Na reunião realizada no primeiro dia de setembro de dois mil e onze, no âmbito de novos cursos de pós-graduação, a professora Nina Rosa da Silveira Cunha expôs informações sobre o andamento do curso lato sensu em Gestão Estratégica e Ambiental. Na mesma oportunidade, tratando sobre o apoio institucional do departamento a eventos e datas comemorativas, o Senhor Presidente prestou esclarecimentos e informou aos presentes sobre as ações ativas de divulgação e homenagem ao Dia do Administrador, realizadas por meio de veiculações em jornal e outdoor em parceria com o Conselho Regional." },
  ...
  2012: {
    events: [
      { "tag": "ensino", "title": "Aula Inaugural de Controladoria e Finanças", "desc": "Ata n.º 289/2012 (23 de março de 2012) Durante a sessão do Colegiado realizada em vinte e três de março de dois mil e doze, os docentes discutiram os avanços e aberturas de cursos na unidade. No momento reservado às comunicações e outros assuntos de interesse do departamento, o professor Wender Fraga Miranda tomou a palavra para prestar informes e ressaltou com sucesso a realização da aula inaugural da nova turma de dois mil e doze a dois mil e quatorze do curso de pós-graduação Lato Sensu em Controladoria e Finanças, que iniciou as suas atividades letivas oficiais registrando o total de 53 alunos matriculados." },
  ...
  2013: {
    events: [
      ...
      { "tag": "ensino", "title": "Aulas Inaugurais e Recepção na Pós-Graduação", "desc": "Ata nº 295/2013 – 4 de abril de 2013 No âmbito das atividades comemorativas e informativas do departamento, a professora Nina Rosa da Silveira Cunha formalizou um convite a todos os membros do Colegiado para comparecerem à aula inaugural do curso de Pós-Graduação Lato Sensu em Gestão Empresarial e Ambiental, cuja realização foi agendada para o dia 6 de abril do referido ano. Adicionalmente, o professor Thiago de Melo Teixeira da Costa trouxe atualizações sobre a estruturação e o cronograma dos cursos de Pós-Graduação Lato Sensu em Gestão Pública e em Gestão Pública Municipal na modalidade a distância, destacando o início do processo seletivo e a previsão da respectiva aula inaugural para o mês de junho de 2013. Por fim, o professor Marco Aurélio Marques Ferreira também abordou a recepção oficial dos 18 novos alunos ingressantes no curso de Pós-Graduação em Administração pelo Chefe do Departamento, além de estender um convite para a aula inaugural do programa programada para o dia 13 de maio do mesmo ano." },
      { "tag": "ensino", "title": "Aula Magna dos Cursos EAD", "desc": "Ata nº 297/2013 – 26 de julho de 2013 Em relação às atividades de extensão e celebrações acadêmicas da instituição, o professor Magnus Luiz Emmendoerfer realizou um convite formal a todo o corpo docente para prestigiar a Aula Magna dos cursos de pós-graduação Lato Sensu na modalidade a distância nas áreas de Gestão Pública e Gestão Pública Municipal, evento agendado para o dia 27 de julho do corrente ano no auditório do Departamento de Engenharia Florestal." },
      { "tag": "gestao", "title": "Participação na Rede PROFIAP", "desc": "Ata nº 299/2013 – 12 de dezembro de 2013 A reunião foi iniciada com o Senhor Presidente prestando uma homenagem de agradecimento ao empenho de cada um dos professores pela conquista institucional da colocação do Mestrado na Capes com o conceito 4. Na sequência da pauta, houve uma celebração aos 20 anos de fundação da CACE por meio de um relato do Diretor Presidente sobre os resultados históricos e prêmios da empresa, o que motivou o professor Marco Aurélio Marques Ferreira a declarar formalmente um voto de louvor à CACE pelos seus relevantes trabalhos. Logo após, também foi celebrada a comemoração dos 10 anos de existência da CECCO, ocasião na qual a sua Diretora Presidente apresentou a missão e as parcerias da associação, recebendo uma menção honrosa de agradecimento do professor Marco Aurélio Marques Ferreira pelo empenho nos eventos e congratulações do Senhor Presidente pelo crescimento e proximidade da CECCO com o DAD." },
  ...
  2014: {
    events: [
      { "tag": "extensao", "title": "Planejamento do 6º Congresso UFV", "desc": "Ata nº 300/2014 (11 de fevereiro de 2014) Nesta data, foi anunciada a realização do 6º Congresso UFV de Administração e Contabilidade, planejado para ocorrer no segundo semestre de 2014 em decorrência da demanda apresentada pelos estudantes. Diante do anúncio, ficou sugerido que as comissões dos cursos de Administração e Ciências Contábeis se reunissem com o objetivo de discutir e alinhar a programação do evento." },
      { "tag": "infraestrutura", "title": "Obras do Anexo e Mudança de Letras", "desc": "Ata nº 302/2014 (11 de junho de 2014) No início desta sessão, a presidência apresentou informes sobre as instalações físicas do departamento, destacando a conclusão da primeira etapa da obra do anexo do DAD, a qual ficava dependendo da liberação de recursos financeiros por parte da UFV para que pudesse ser finalizada. Adicionalmente, foi comunicada aos presentes a mudança do Departamento de Letras e a respectiva reforma do prédio." },
      { "tag": "ensino", "title": "Novas Turmas PNAP e Aula do PROFIAP", "desc": "Ata nº 303/2014 (19 de setembro de 2014) Nesta ocasião, foi aprovado o oferecimento de novas turmas de cursos de pós-graduação lato sensu para o ano de 2015, integradas ao Programa Nacional de Formação em Administração Pública (PNAP). Os cursos anunciados, que serão ministrados na modalidade a distância, correspondem à nova turma de Gestão Pública Municipal e à nova turma de Gestão Pública. Também foram compartilhadas informações sobre a aula inaugural do PROFIAP, agendada para o dia 11 de outubro do mesmo ano no campus de Florestal. Por fim, reportou-se o planejamento e a organização do Seminário de Administração e Contabilidade, previsto para ser realizado na primeira quinzena de maio de 2015 com a oferta de minicursos." },
      {
        tag: 'ensino',
        title: 'Homologação de Nova Turma de Especialização e Anúncio do 6º Congresso UFV (11 de fevereiro de 2014)',
        desc: 'O Colegiado tratou de assuntos voltados à pós-graduação e eventos acadêmicos, homologando o oferecimento da turma 2014-2016 e a respectiva planilha de custos do Curso de Pós-Graduação Lato Sensu em Controladoria e Finanças. Além disso, foi anunciada a realização do 6º Congresso UFV de Administração e Contabilidade, agendado para o segundo semestre de 2014 para atender à demanda dos estudantes.'
      },
      {
        tag: 'gestao',
        title: 'Definição da Instalação do PROFIAP e Nomeação na Coordenação da CACE (29 de abril de 2014)',
        desc: 'Durante a sessão, o Colegiado recebeu informações atualizadas sobre a implantação do mestrado PROFIAP e discutiu os termos de oferta e as exigências da CAPES, mencionando a sugestão de que a instalação física do programa ocorresse no campus de Florestal. Também foi formalizada a nomeação do professor Edson Arlindo Silva para o cargo de novo Coordenador Técnico da CACE, em substituição a um docente anterior.'
      },
      {
        tag: 'infraestrutura',
        title: 'Conclusão da Primeira Etapa das Obras do Anexo e Indicação à Medalha Peter Rolfs (11 de junho de 2014)',
        desc: 'O presidente do departamento trouxe informes sobre a infraestrutura física, detalhando a conclusão da primeira etapa das obras do anexo do DAD, que ficaria no aguardo da liberação de recursos institucionais para a sua finalização, além de mencionar planos para a reforma do prédio e mudanças envolvendo o Departamento de Letras. No âmbito das homenagens acadêmicas, o Colegiado aprovou por unanimidade a indicação de um docente para concorrer à Medalha de Ouro Peter Rolfs do Mérito em Extensão, respaldado pelo interesse manifestado também por estudantes de empresas juniores.'
      },
      {
        tag: 'ensino',
        title: 'Abertura de Novos Cursos Reais em EAD e Agendamento de Aula Inaugural do PROFIAP (19 de setembro de 2014)',
        desc: 'O Colegiado aprovou a abertura e o oferecimento de novas turmas de cursos de pós-graduação lato sensu na modalidade a distância para o ano de 2015, sendo uma em Gestão Pública Municipal e outra em Gestão Pública, ambas vinculadas ao Programa Nacional de Formação em Administração Pública (PNAP). Também foi anunciada a realização da aula inaugural do PROFIAP no campus de Florestal, programada para o dia 11 de outubro do mesmo ano, e compartilhadas informações sobre a organização do Seminário de Administração e Contabilidade, planejado para a primeira quinzena de maio de 2015 com a oferta de minicursos.'
      }
    ],
    photos: [],
    articleUrl: ''
  ...
  2015: {
    events: [
      { "tag": "gestao", "title": "Retorno de Docente e Sede do CAADM", "desc": "Ata nº 307/2015 (17 de abril de 2015) Na abertura da reunião, o Presidente do Colegiado deu as boas-vindas ao retorno de um docente recém-chegado do seu programa de doutorado. Adicionalmente, durante a apresentação das atividades do Centro Acadêmico de Administração (CAADM), foi destacada a estruturação da sede da referida entidade estudantil ocorrida ao longo das ações do ano de 2014." },
      { "tag": "gestao", "title": "Concessão de Medalhas e Planejamento de Aniversários", "desc": "Ata nº 310/2015 (25 de agosto de 2015) A Presidência do Colegiado comunicou o recebimento de um ofício da Secretaria de Órgãos Colegiados informando sobre a concessão de honrarias institucionais a integrantes do departamento, sendo anunciada a entrega da Medalha Bello Lisboa a dois professores e da Medalha José Valentino da Cruz (Candinho) a um técnico-administrativo, em reconhecimento aos serviços prestados à instituição. Na mesma reunião, na seção de outros assuntos, foi sugerida a inclusão em pauta do planejamento dos eventos celebrativos de aniversários de fundação vinculados ao departamento, que compreendem as comemorações dos 15 anos do Curso de Ciências Contábeis, 10 anos da Pós-Graduação em Administração, 40 anos do curso de Administração e os 50 anos do Departamento de Administração e Contabilidade." },
      { "tag": "gestao", "title": "Representação Discente e Painel ComuniDAD", "desc": "Ata nº 312/2015 (22 de setembro de 2015) A Presidência deu as boas-vindas ao novo integrante discente do Colegiado que assumiu a representação do Curso de Ciências Contábeis. Nos informes, foi anunciada a realização do evento comemorativo do Departamento de Administração e Contabilidade, agendado para o dia 18 de novembro daquele ano. Por fim, no segmento de outros assuntos, registrou-se a inauguração de um painel de exposição artística nas dependências do departamento, batizado de “ComuniDAD”." },
      { "tag": "extensao", "title": "Visita Internacional e Evento Gestão e Perspectiva", "desc": "Ata nº 314/2015 (27 de outubro de 2015) A Diretora da Editora UFV foi recebida pelo Colegiado e realizou uma apresentação institucional detalhada sobre a estrutura e os projetos da editora. Nos informes da presidência, foram divulgados os detalhes do evento comemorativo do Departamento de Administração e Contabilidade, intitulado 'Gestão e Perspectiva', com realização marcada para o dia 17 de novembro de 2015 no auditório do Agros. Também foi anunciada a data da confraternização natalina do departamento, programada para o dia 27 de novembro daquele ano, além do registro da visita de um professor da Kansas State University com vistas ao estabelecimento de parcerias. Nos assuntos finais, foi comunicado o início do novo curso de doutorado, previsto para ser implantado no primeiro semestre de 2016." },
      ...
      { tag: 'ensino', title: 'Constituição de Banca para Titular e Resultados da CACE', desc: '11 de dezembro de 2014: Durante a reunião do colegiado, foram indicados os nomes para a constituição da banca examinadora do processo de promoção à categoria de professor titular, incluindo os docentes Walmer Faroni, da UFV, além de representantes da UFMS, UFMG e UFLA, com a professora Nina Rosa da Silveira Cunha como suplente. No âmbito das atividades estudantis, o Diretor Presidente da CACE, Vitor Mól Lombardi, apresentou resultados da organização, destacando a importância da empresa júnior para a formação dos alunos de Administração e as diversas premiações e reconhecimentos recebidos, como o prêmio qualidade e produtividade da Federação de Ejs de Minas Gerais.' },
      ...
      { tag: 'ensino', title: 'Retomada do CAADM e Tramitação do Doutorado em Administração', desc: '17 de abril de 2015: O Vice-Presidente do Centro Acadêmico de Administração (CAADM), Brendow de Oliveira Fraga, apresentou formalmente a retomada das atividades da entidade estudantil, destacando a estruturação de sua sede física e a formalização perante os órgãos da universidade. No campo da pós-graduação, informou-se que o processo para a criação do curso de doutorado em Administração foi aprovado pelo Conselho de Ensino, Pesquisa e Extensão (CEPE) e encaminhado para a avaliação da CAPES.' },
      { tag: 'gestao', title: 'Homologação do Doutorado e Demandas de Infraestrutura da Pós-Graduação', desc: '12 de junho de 2015: Nesta sessão, o colegiado homologou o ato ad referendum referente à criação do curso de Doutorado em Administração, formalizado pelo processo 006623/2015. Na mesma reunião, o representante dos discentes de pós-graduação, Rafael Júnior dos Santos Figueiredo Salgado, apresentou demandas relativas à infraestrutura física, solicitando a aquisição de novas cadeiras e computadores para a sala do mestrado.' },
      { tag: 'gestao', title: 'Sucessão na Chefia do Departamento e Eleição de Simone Martins', desc: '26 de junho de 2015: A reunião marcou a sucessão na chefia do Departamento de Administração e Contabilidade, onde a professora Simone Martins foi eleita para o cargo com 17 votos favoráveis. Na ocasião, a nova chefe eleita e a Diretora do Centro de Ciências Humanas parabenizaram o professor Djair Cesário de Araújo pela gestão que se encerrava, desejando sucesso à nova administração. Além disso, foram repassados informes sobre obras em andamento e a tramitação do processo de criação do doutorado junto aos órgãos reguladores.' }
    ],
    photos: [],
    articleUrl: ''
  },
  2016: {
    events: [
      { tag: 'gestao', title: 'Infraestrutura do Terceiro Andar, Biblioteca e Nova Coordenação', desc: '04 de março de 2016: Durante a reunião do Colegiado, foram discutidas questões relativas às instalações físicas e à ocupação de espaços do departamento, destacando-se a perspectiva de implementação do projeto para a ocupação do terceiro andar e a discussão sobre a gestão e forma de ocupação do anexo do CCH1/CTinfra e FINEP, que contará com reuniões entre chefes de departamento e coordenadores da proposta. Além disso, informou-se sobre a finalização das obras da Biblioteca Setorial, cujas dependências serão destinadas às secretarias de pós-graduação stricto sensu e lato sensu, enquanto seu acervo será transferido para o anexo sob gerenciamento da Biblioteca Central. No âmbito das nomeações, o professor Magnus Luiz Emmendoerfer foi formalizado como o novo coordenador do Programa de Pós-Graduação Stricto Sensu. Também foi mencionada a Aula Magna dos cursos de mestrado e doutorado em Administração, a ser proferida pela professora María del Carmen Pineda Nebot em 11 de março de 2016 na sala de conferências do DAD.' },
      { tag: 'gestao', title: 'Plano de Gestão, Metas e Regimento Interno do DAD', desc: '10 de março de 2016: Nesta data, em reunião das comissões do departamento, a professora Simone Martins abordou o plano de gestão e metas, ressaltando a necessidade de criação de políticas específicas para o ensino, pesquisa e extensão, além da proposição de um regimento interno para o DAD. O encontro serviu para alinhar a estrutura organizacional e as competências das comissões para a futura composição do regimento específico do departamento.' },
      { tag: 'ensino', title: 'Fundação da Liga Acadêmica de Mercado e Gestão de Ativos', desc: '13 de maio de 2016: Nesta reunião do Colegiado, houve o anúncio da fundação e da coordenação docente da Liga Acadêmica de Mercado e Gestão de Ativos (LAMG), caracterizada como uma iniciativa estudantil multicursos voltada ao aprofundamento de conhecimentos sobre mercado de capitais e gestão de ativos.' },
      { tag: 'gestao', title: 'Atualizações Físicas, Segurança e Nova Coordenação de Curso', desc: '15 de abril de 2016: Nesta reunião, foram discutidas atualizações significativas nas instalações físicas do departamento, incluindo o agendamento de uma revisão do projeto de ocupação do terceiro andar para adequá-lo ao Plano de Gestão, com auxílio da Pró-Reitoria de Administração para reformas. A ocupação do anexo do prédio CCH1 foi prevista para agosto de 2016, acompanhada pela instalação de um novo sistema de segurança com monitoramento por vídeo e a compra de roteadores para melhorar a internet no local. No âmbito acadêmico, o professor Djair Cesário de Araújo foi anunciado como o novo coordenador do curso de Administração.' },
      { tag: 'gestao', title: 'Deliberações sobre Medalhas de Mérito Departamental', desc: '10 de junho de 2016: Nesta reunião, o Colegiado discutiu a indicação de candidatos para a Medalha de Ouro Peter H. Rolfs do Mérito em Pesquisa e para a Medalha da Ordem do Mérito do Ex-Aluno, decidindo postergar as definições para o encontro seguinte. Também foi abordada a indicação de candidatos à Medalha de Ouro Peter H. Rolfs do Mérito em Ensino, cuja decisão igualmente ficou para a próxima reunião.' },
      { tag: 'reconhecimento', title: 'Protocolos de Segurança do CCH1 e Congratulações a Docente', desc: '10 de junho de 2016: Durante a reunião do colegiado, foram comunicadas importantes atualizações sobre a infraestrutura e segurança do departamento, incluindo a definição da forma de ocupação do terceiro andar e a instalação de câmeras de monitoramento nas áreas internas e externas, sob vigilância técnica. Além disso, estabeleceu-se um novo protocolo de acesso ao prédio do CCH1, que passaria a permanecer fechado após as dezoito horas e trinta minutos a partir do dia 13 de junho daquele ano. No âmbito das homenagens e méritos acadêmicos, houve a aprovação extrapauta para a indicação da Medalha de Ouro Peter H. Rolfs do Mérito em Ensino, além do registro formal de congratulações ao professor Marco Aurélio Marques Ferreira por sua indicação ao cargo de Diretor de Publicação e Comunicação pela Associação Brasileira de Administração Pública.' },
      { tag: 'gestao', title: 'Planejamento Físico e Priorização do Edifício CCH I', desc: '23 de junho de 2016: Em reunião extraordinária com a presença da Diretoria do Centro de Ciências Humanas, Letras e Artes, discutiu-se o planejamento físico institucional com foco na ampliação e reestruturação do espaço do departamento. O ponto central desse debate foi o compromisso de pautar o projeto do Edifício CCH I como uma prioridade junto à Pró-Reitoria de Administração, visando melhorias estruturais para a unidade.' },
      { tag: 'reconhecimento', title: 'Indicação de Mérito em Ensino e Nova Editoria da Revista APGS', desc: '01 de julho de 2016: A sessão trouxe atualizações sobre as instalações físicas, informando que a proposta de Regimento Interno do DAD, sob responsabilidade do administrador Jansen Cardoso Pereira, estava em fase de organização e que as discussões sobre a ocupação do terceiro andar continuavam. No campo das homenagens, a professora Telma Regina da Costa Guimarães Barbosa foi indicada por unanimidade para concorrer à Medalha de Ouro Peter H. Rolfs do Mérito em Ensino, sendo destacada como pioneira no ensino a distância na UFV. Para formalizar esta indicação, foi composta uma comissão pelos professores Afonso Augusto Teixeira de Freitas de Carvalho Lima, Nina Rosa da Silveira Cunha e Suely de Fátima Ramos Silveira. Não houve indicações para as medalhas de Mérito em Pesquisa e da Ordem do Mérito do Ex-Aluno nesta data. Além disso, o professor Josiel Lopes Valadares foi nomeado para o cargo de editor adjunto da revista Administração Pública e Gestão Social (APGS).' },
      { tag: 'gestao', title: 'Docentes Substitutos, Tutoria do PET e Gestão Predial', desc: '12 de agosto de 2016: Nesta data, foram anunciadas as posses dos professores substitutos Gustavo José Padula de Souza e João Paulo de Oliveira Louzano, além da eleição do professor Thiago de Melo Teixeira da Costa como o novo tutor do PET-ADM. Em termos de infraestrutura e gestão predial, informou-se que os equipamentos para o sistema de segurança interna e externa do prédio CCH1 foram adquiridos, a compra de equipamentos para a internet do DAD estava em fase de conclusão e o administrador Jansen Cardoso Pereira foi nomeado como o novo síndico do prédio. O departamento também se preparava para o Simpósio Internacional de Administração Pública, que contaria com a visita do professor Joaquín Brugué Torruella.' },
      { tag: 'reconhecimento', title: 'Premiações Docentes e Evento Gestão em Perspectivas', desc: '09 de setembro de 2016: O Colegiado registrou congratulações ao professor Josiel Lopes Valadares pelo recebimento do Prêmio Guerreiro Ramos de Gestão Pública e ao professor Magnus Luiz Emmendoerfer pela realização do Simpósio Internacional de Administração Pública (SINAP). Quanto às instalações, foi destacado que o laboratório de informática passou a contar com o sistema Windows legalizado. Foi anunciado que o evento Gestão em Perspectivas ocorreria nos dias 22 e 23 de setembro, com a recomendação de liberação dos estudantes para participação. Nas discussões sobre o Regimento Interno, definiu-se a inclusão de capítulos específicos sobre a organização do departamento e do colegiado, incorporando artigos do Estatuto da UFV e detalhando a composição das instâncias de decisão.' },
      { tag: 'extensao', title: 'Prestação de Contas do Evento e Regulação Interna', desc: '21 de outubro de 2016: Durante a sessão do Colegiado, a prestação de contas da segunda edição do evento "Gestão em Perspectivas" foi apresentada pelos coordenadores, que também discutiram a organização da celebração para o ano seguinte. No que tange à regulamentação interna, o debate sobre o Regimento Interno do DAD avançou para definir a estrutura das instalações e os recursos materiais necessários às atividades departamentais, além de formalizar a composição do corpo docente e técnico-administrativo.' },
      { tag: 'extensao', title: 'Pós-Graduação Lato Sensu e Parcerias Internacionais', desc: '02 de dezembro de 2016: A reunião de encerramento do ano trouxe atualizações sobre a gestão de novos cursos de pós-graduação lato sensu, com a Funarbe colocando-se à disposição para a gestão financeira caso a oferta seja aprovada pela Pró-Reitoria. Houve também a discussão sobre a reestruturação e possível oferta futura desses cursos, além do anúncio do lançamento de um e-book contendo as palestras dos Seminários Internacionais em Administração Pública (SINAP). Por fim, foi informada a vinda de dois professores em estágio pós-doutoral para o DAD em 2017: Rodrigo Garrido, da UFRJ, e Javier Cruz Mentuy, da Universidad de Cádiz, na Espanha.' }
    ],
    photos: [],
    articleUrl: ''
  },
  2017: {
    events: [
      { tag: 'gestao', title: 'Boas-vindas e Reformas de Férias nas Instalações', desc: '17 de março de 2017: Nesta data, o Colegiado deu as boas-vindas ao professor Ronan Pereira Capobiango, que assumiu a coordenação da Empresa Júnior de Ciências Contábeis (CECCO), e à servidora Amanda Oliva Pereira. Foram realizados diversos agradecimentos públicos: ao professor Bruno de Jesus Lopes, pelos resultados alcançados em sua gestão frente à CECCO; ao servidor Thiago dos Santos, pelos serviços prestados ao departamento; e ao professor João Paulo de Oliveira Louzano, por sua contribuição durante a permanência no órgão. Em relação às melhorias nas instalações físicas realizadas no período de férias, destacaram-se a manutenção do jardim, pintura de corrimãos, reforma e troca de cortinas na sala de conferência, reforma de cadeiras, instalação de portaria, novas placas de sinalização, conclusão do sistema de segurança por vídeo monitoramento e reforma do piso da sala de mestrado.' },
      { tag: 'reconhecimento', title: 'Prestação de Contas e Legado da Primeira Chefe do DAD', desc: '24 de agosto de 2017: Durante a prestação de contas da gestão 2015-2017, foram destacados avanços significativos na infraestrutura e organização do departamento, como a preparação do plano de ocupação do anexo do CCH I, a ampliação do espaço físico para pós-graduandos e a criação de novas salas de aula e de iniciação científica. No âmbito administrativo e de pessoal, ressaltou-se a recuperação da vaga de administrador do DAD e o fortalecimento de comissões de apoio. A professora Simone Martins foi homenageada pelos docentes presentes, que a parabenizaram pelo legado de profissionalismo e dedicação, destacando o marco histórico de ter sido a primeira mulher a ocupar a chefia do departamento.' },
      { tag: 'gestao', title: 'Elaboração da Lista Tríplice para Nova Chefia', desc: '25 de agosto de 2017: Nesta reunião extraordinária, presidida pela Diretora do Centro de Ciências Humanas, Letras e Artes, o Colegiado formalizou a elaboração da lista tríplice para a escolha do novo Chefe do Departamento. O professor Bruno Tavares foi eleito para o primeiro lugar da lista, recebendo dezenove votos favoráveis, seguido pela professora Nina Rosa da Silveira Cunha em segundo lugar e pelo professor Afonso Augusto Teixeira de Freitas de Carvalho Lima em terceiro. O professor eleito foi parabenizado pela presidência e agradeceu a confiança depositada para o exercício do cargo.' },
      { tag: 'ensino', title: 'Intervenções Prediais e Recepção Unificada de Calouros', desc: '17 de março de 2017: Durante o período de férias, o Departamento de Administração e Contabilidade realizou diversas intervenções em suas instalações físicas, incluindo a manutenção do jardim, pintura de corrimãos, reforma e troca de cortinas na sala de conferência, além da reforma de cadeiras e a instalação de uma portaria com funcionamento em horário estendido. Foram concluídas as instalações de placas de sinalização no Edifício CCH1, sistemas de segurança por vídeo monitoramento e a reforma do piso da sala de mestrado. Em termos de pessoal, o professor João Paulo Louzano de Oliveira foi homenageado com agradecimentos por sua contribuição ao DAD ao se desligar para assumir vaga em outra universidade federal. Para marcar o início das atividades acadêmicas, foi organizada a recepção dos calouros dos cursos de Administração e Ciências Contábeis com palestras e boas-vindas da chefia do departamento e da diretoria do centro.' },
      { tag: 'extensao', title: 'Previsão de Entrega do Anexo e Atividades de Pós-Doutorado', desc: '12 de maio de 2017: Nesta data, foi informada a previsão de entrega da obra do anexo para o dia 15 de maio de 2017, embora com a pendência técnica do elevador e ainda sem o mobiliário necessário. A gestão manifestou a intenção de reivindicar mobiliário específico para o Auditório, propondo em contrapartida a disponibilização do espaço para uso geral da universidade. No campo dos eventos e reconhecimento docente, houve homenagens e parabenizações aos professores Thiago de Melo Teixeira da Costa e Wescley Silva Xavier pela realização de eventos de discussão sobre a previdência social e pesquisa, respectivamente. Além disso, o professor Paulo Diniz foi anunciado como novo integrante para desenvolver atividades de pós-doutorado junto ao departamento no início de junho.' },
      { tag: 'gestao', title: 'Segurança Predial, Recursos de Equipamentos e Chefia Interina', desc: '23 de junho de 2017: Nesta data, foram relatadas questões significativas sobre as instalações físicas e a gestão do Departamento de Administração e Contabilidade. Houve o registro de uma ocorrência de furto nas dependências do Edifício CCH 1 no dia 17 de junho, o que levou à verificação da vulnerabilidade das instalações e a uma solicitação para que todos os docentes conferissem o fechamento das janelas de seus gabinetes. No âmbito das nomeações e liderança institucional, foi anunciado que o professor Afonso Augusto Teixeira de Freitas de Carvalho Lima assumiria a chefia do DAD durante o mês de julho, em substituição à professora Simone Martins devido ao seu período de folga e férias. Além disso, informou-se sobre a liberação de uma parcela de R$ 7.000,00 destinada à aquisição de equipamentos para o departamento, com prioridade para o atendimento dos cursos de graduação e pós-graduação, incluindo a autorização prévia do Centro para a compra de roteadores.' },
      { tag: 'gestao', title: 'Votação Secreta e Resultado da Lista Tríplice', desc: '25 de agosto de 2017: Durante a reunião extraordinária do Colegiado, ocorreu o processo de execução da lista tríplice para a escolha da nova chefia do Departamento de Administração e Contabilidade, motivado pelo encerramento do mandato de dois anos da professora Simone Martins. Na ocasião, o professor Bruno Tavares foi eleito para ocupar o primeiro lugar da lista após votação secreta, recebendo dezenove votos favoráveis. A composição oficial da lista para a nomeação do próximo chefe foi completada com a eleição da professora Nina Rosa da Silveira Cunha para o segundo lugar e do professor Afonso Augusto Teixeira de Freitas de Carvalho Lima para o terceiro lugar.' }
    ],
    photos: [],
    articleUrl: ''
  },
  2018: {
    events: [
      { tag: 'gestao', title: 'Novos Integrantes e Conclusão de Obras nos Andares', desc: '22 de março de 2018: Nesta data, o Senhor Presidente deu as boas-vindas ao professor Antônio Carlos Brunozi Júnior como o novo integrante do Colegiado e ao professor Wender Fraga Miranda por seu retorno após a conclusão do doutorado. No âmbito das instalações físicas, foi comunicada a finalização de parte das obras realizadas no segundo e terceiro andares do prédio, acompanhada de um convite a todos os presentes para conhecerem as novas dependências. Além disso, houve o registro de uma homenagem e congratulação à comissão responsável pela organização da recepção dos calouros do departamento.' },
      { tag: 'gestao', title: 'Nomeação de Coordenadores de Administração e Contabilidade', desc: '26 de abril de 2018: Durante a reunião, o Colegiado formalizou a nomeação de novos coordenadores para os cursos oferecidos pelo departamento, sendo designado o professor Evandro Rodrigues de Faria para a coordenação do curso de Administração e o professor Antônio Carlos Brunozi Júnior para a coordenação do curso de Ciências Contábeis. Adicionalmente, o Senhor Presidente proferiu palavras de parabenização a todos os profissionais da área de Contabilidade.' },
      { tag: 'extensao', title: 'Eventos Acadêmicos e Agenda com a Direção do CCH', desc: '15 de junho de 2018: Neste encontro, o Senhor Presidente parabenizou formalmente o professor Magnus Luiz Emmendoerfer pela organização e realização de um evento acadêmico ocorrido nos dias anteriores. No campo das relações institucionais, foi confirmada a pré-agenda para o mês de agosto de uma reunião de apresentação formal do professor Odemir Vieira Baêta, na qualidade de Diretor do Centro de Ciências Humanas, Letras e Artes.' },
      { tag: 'reconhecimento', title: 'Acolhimento de Calouros e Retorno do Doutorado', desc: '22 de março de 2018: Nesta reunião, o Colegiado deu as boas-vindas ao professor Antônio Carlos Brunozi Júnior, novo integrante do Colegiado, e ao professor Wender Fraga Miranda, recém-chegado do doutorado. Em relação às instalações físicas, foi anunciada a finalização de parte das obras realizadas no segundo e terceiro andares do departamento, com um convite aberto a todos para conhecerem as melhorias. Além disso, houve uma homenagem formal à comissão responsável pela recepção dos calouros, parabenizando-os pela excelência na condução das atividades de acolhimento.' },
      { tag: 'ensino', title: 'Designação de Lideranças de Curso e Homenagem ao Setor', desc: '26 de abril de 2018: Durante a sessão, foram anunciadas as nomeações dos novos coordenadores de curso para o departamento, sendo o professor Evandro Rodrigues de Faria designado para a coordenação de Administração e o professor Antônio Carlos Brunozi Júnior para a de Ciências Contábeis. O Senhor Presidente também aproveitou a oportunidade para parabenizar formalmente todos os profissionais de contabilidade pela sua atuação.' },
      { tag: 'extensao', title: 'Encontro Brasileiro de Administração Pública e Visita do CCH', desc: '15 de junho de 2018: O Senhor Presidente parabenizou o professor Magnus Luiz Emmendoerfer pela realização do V Encontro Brasileiro de Administração Pública. Na mesma reunião, foi anunciada a pré-agenda para o mês de agosto de uma visita de apresentação formal do novo Diretor do Centro de Ciências Humanas, Letras e Artes (CCH), professor Odemir Vieira Baêta.' },
      { tag: 'gestao', title: 'Término Total das Obras no Terceiro Andar do CCH I', desc: '17 de agosto de 2018: A reunião foi marcada pelas boas-vindas à professora Tainá Rodrigues Gomide Souza Pinto por seu retorno após a conclusão do doutorado. Nos informes sobre a infraestrutura do departamento, foi comunicado oficialmente o término das obras no terceiro andar do prédio CCH I.' },
      { tag: 'reconhecimento', title: 'Novas Servidoras de Apoio e Aniversário do PET ADM', desc: '14 de setembro de 2018: O Colegiado registrou a presença das servidoras Ana Paula e Priscila, que passaram a compor a equipe responsável pelo serviço de limpeza e manutenção do departamento. No âmbito das celebrações institucionais, o professor Thiago de Melo Teixeira da Costa destacou a comemoração dos 30 anos de existência do PET ADM no departamento.' },
      { tag: 'ensino', title: 'Representação Estudantil e Novo Curso de Capacitação EaD', desc: '30 de novembro de 2018: Nesta data, o Colegiado deu as boas-vindas às novas representantes discentes Julia Sabino Carneiro e Bárbara Tavares de Paula, que passaram a integrar as reuniões do departamento. Além disso, foi aprovada a abertura de um novo curso de capacitação profissional na modalidade a distância, intitulado "Gestão de Risco de Contrato no Setor Público", com previsão de início para o primeiro semestre de 2019.' },


      {
        tag: 'ensino',
        title: 'Celebração de 30 Anos do PET ADM e 1° Startup Day UFV (26 de outubro de 2018)',
        desc: 'Nesta data, foi anunciado que a comemoração dos 30 anos do PET ADM estava agendada para acontecer no dia 23 de novembro daquele ano. Além disso, informou-se sobre a realização do demoday do evento 1° Startup Day UFV, um concurso de ideias de negócios voltado para fomentar a interação entre as disciplinas de empreendedorismo da universidade, programado para o dia 28 de outubro. Também foi comunicada a mudança de gestão da Central de Empresas Juniores, com a posse do novo coordenador prevista para ocorrer no dia 3 de novembro durante o Internej (Encontro Interno de Empresas Juniores da UFV).'
      },

      {
        tag: 'ensino',
        title: 'Balanço do PET ADM e Novo Curso EAD de Gestão de Risco (30 de novembro de 2018)',
        desc: 'Durante a sessão, o professor Thiago de Melo Teixeira da Costa abordou formalmente a comemoração dos 30 anos do PET, recebendo felicitações dos demais docentes pelo sucesso do evento comemorativo recém-realizado. Na mesma oportunidade, o colegiado aprovou por unanimidade a proposta apresentada pela professora Nálbia de Araújo Santos para a abertura e criação de um novo curso de capacitação profissional na modalidade a distância, intitulado "Gestão de Risco de Contrato no Setor Público", com carga de 82 horas e previsão de início para o primeiro semestre do ano seguinte.'
      }
    ],
    photos: [],
    articleUrl: ''
  ...
  2019: {
    events: [
      {
        tag: 'infraestrutura',
        title: 'Ajustes Finais no 3º Andar e Novos Computadores para o Laboratório (5 de abril de 2019)',
        desc: 'No âmbito das instalações físicas do departamento, foi informado à comunidade docente que faltavam apenas pequenos ajustes estruturais para a conclusão definitiva das obras realizadas no 3º andar do prédio. Adicionalmente, reportou-se que o Centro de Ciências Humanas, Letras e Artes (CCH) realizaria a cessão de quatro novos computadores destinados à melhoria da infraestrutura do laboratório de informática do departamento.'
      },
      {
        tag: 'ensino',
        title: 'Tratativas para Novo Curso EAD em Conceição do Mato Dentro (17 de maio de 2019)',
        desc: 'Nesta reunião, foram prestadas informações a respeito do andamento de tratativas institucionais junto à pró-reitoria de ensino para a futura elaboração e oferta de um novo curso na modalidade de Educação a Distância (EAD), planejado para ser implementado no município de Conceição do Mato Dentro.'
      },
      {
        tag: 'infraestrutura',
        title: 'Liberação do Acesso ao CCH1 e Ocupação do Terceiro Andar (18 de junho de 2019)',
        desc: 'No que diz respeito às instalações físicas do departamento, foi formalmente comunicado aos membros do colegiado que o acesso ao prédio CCH1 havia sido liberado por meio de seu anexo. Adicionalmente, durante a mesma sessão, houve uma manifestação informativa em plenário a respeito do processo de ocupação do terceiro andar da edificação por parte dos estudantes.'
      },
      {
        tag: 'gestao',
        title: 'Gerenciamento de Espaços e Demandas de Municípios Parceiros (16 de agosto de 2019)',
        desc: 'Nesta reunião, os membros do colegiado debateram a ocupação e o gerenciamento dos espaços físicos institucionais, registrando o acolhimento de demandas provenientes de municípios parceiros, as quais apontavam para oportunidades futuras voltadas à criação e ao desenvolvimento de novos cursos.'
      },
      {
        tag: 'gestao',
        title: 'Parecer da Comissão sobre Alocação do PDPL no CCH1 (23 de agosto de 2019)',
        desc: 'Ocorreu uma deliberação sobre as instalações físicas do departamento relacionada à proposta de instalação do PDPL no subsolo do Departamento de Economia. O colegiado, acompanhando o parecer da Comissão de Estrutura, Gestão e Patrimônio, posicionou-se contrariamente à solicitação original e sugeriu, de forma alternativa, que o Departamento de Economia realizasse a liberação de seis módulos situados especificamente no terceiro andar do prédio CCH1, na ala que se encontrava alocada por aquela unidade.'
      }
    ],
    photos: [],
    articleUrl: ''
  ...
  2020: {
    events: [
      { tag: 'infraestrutura', title: 'Inauguração do Auditório e Novos Equipamentos', desc: 'Inauguração do auditório do CCH1, compartilhado com o DEE, e aquisição de 15 novos computadores para o laboratório de informática. Atualização da logomarca oficial do DAD.' },
      { tag: 'ensino', title: 'Pós-graduação Lato Sensu', desc: 'Aprovação do curso de especialização em Administração Pública Municipal pela Pró-Reitoria de Pesquisa e Pós-Graduação (PPG).' },
      { tag: 'gestao', title: 'Manutenção e Planejamento de Mérito', desc: 'Realização de reformas na sala 200 e organização das comissões para indicações às Medalhas de Mérito da UFV.' },
      { tag: 'infraestrutura', title: 'Nova Sede do PET/ADM', desc: 'Mudança física das instalações do Programa de Educação Tutorial de Administração para o terceiro andar do prédio CCH1.' },
      { tag: 'gestao', title: 'Modernização Tecnológica', desc: 'Aquisição de mais 10 computadores e solicitação junto à DTI para correção da infraestrutura de rede de internet do departamento.' },
    ],
    photos: [],
    articleUrl: ''
  },
