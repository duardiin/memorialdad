...
export const memorialData: MemorialData = {
  ...
  2016: {
    events: [
      ...
      { tag: 'extensao', title: 'Prestação de Contas do Evento e Regulação Interna', desc: 'ATA 325. 21 de outubro de 2016: Durante a sessão do Colegiado, a prestação de contas da segunda edição do evento "Gestão em Perspectivas" foi apresentada pelos coordenadores, que também discutiram a organização da celebração para o ano seguinte. No que tange à regulamentação interna, o debate sobre o Regimento Interno do DAD avançou para definir a estrutura das instalações e os recursos materiais necessários às atividades departamentais, além de formalizar a composição do corpo docente e técnico-administrativo.' },

      { tag: 'extensao', title: 'Pós-Graduação Lato Sensu e Parcerias Internacionais', desc: 'ATA 326. 02 de dezembro de 2016: A reunião de encerramento do ano trouxe atualizações sobre a gestão de novos cursos de pós-graduação lato sensu, com a Funarbe colocando-se à disposição para a gestão financeira caso a oferta seja aprovada pela Pró-Reitoria. Houve também a discussão sobre a reestruturação e possível oferta futura desses cursos, além do anúncio do lançamento de um e-book contendo as palestras dos Seminários Internacionais em Administração Pública (SINAP). Por fim, foi informada a vinda de dois professores em estágio pós-doutoral para o DAD em 2017: Rodrigo Garrido, da UFRJ, e Javier Cruz Mentuy, da Universidad de Cádiz, na Espanha.' }
    ],
    photos: [],
    articleUrl: ''
  },
  ...
  2018: {
    events: [
      ...
      { tag: 'extensao', title: 'Eventos Acadêmicos e Agenda com a Direção do CCH', desc: 'Ata nº 337/2018. 15 de junho de 2018: Neste encontro, o Senhor Presidente parabenizou formalmente o professor Magnus Luiz Emmendoerfer pela organização e realização de um evento acadêmico ocorrido nos dias anteriores. No campo das relações institucionais, foi confirmada a pré-agenda para o mês de agosto de uma reunião de apresentação formal do professor Odemir Vieira Baêta, na qualidade de Diretor do Centro de Ciências Humanas, Letras e Artes.' },
      { tag: 'reconhecimento', title: 'Acolhimento de Calouros e Retorno do Doutorado', desc: 'Ata nº 335/2018. 22 de março de 2018: Nesta reunião, o Colegiado deu as boas-vindas ao professor Antônio Carlos Brunozi Júnior, novo integrante do Colegiado, e ao professor Wender Fraga Miranda, recém-chegado do doutorado. Em relação às instalações físicas, foi anunciada a finalização de parte das obras realizadas no segundo e terceiro andares do departamento, com um convite aberto a todos para conhecerem as melhorias. Além disso, houve uma homenagem formal à comissão responsável pela recepção dos calouros, parabenizando-os pela excelência na condução das atividades de acolhimento.' },
      { tag: 'ensino', title: 'Designação de Lideranças de Curso e Homenagem ao Setor', desc: 'Ata nº 336/2018. 26 de abril de 2018: Durante a sessão, foram anunciadas as nomeações dos novos coordenadores de curso para o departamento, sendo o professor Evandro Rodrigues de Faria designado para a coordenação de Administração e o professor Antônio Carlos Brunozi Júnior para a de Ciências Contábeis. O Senhor Presidente também aproveitou a oportunidade para parabenizar formalmente todos os profissionais de contabilidade pela sua atuação.' },
      { tag: 'extensao', title: 'Encontro Brasileiro de Administração Pública e Visita do CCH', desc: 'Ata nº 337/2018. 15 de junho de 2018: O Senhor Presidente parabenizou o professor Magnus Luiz Emmendoerfer pela realização do V Encontro Brasileiro de Administração Pública. Na mesma reunião, foi anunciada a pré-agenda para o mês de agosto de uma visita de apresentação formal do novo Diretor do Centro de Ciências Humanas, Letras e Artes (CCH), professor Odemir Vieira Baêta.' },
      { tag: 'gestao', title: 'Término Total das Obras no Terceiro Andar do CCH I', desc: 'Ata nº 338/2018. 17 de agosto de 2018: A reunião foi marcada pelas boas-vindas à professora Tainá Rodrigues Gomide Souza Pinto por seu retorno após a conclusão do doutorado. Nos informes sobre a infraestrutura do departamento, foi comunicado oficialmente o término das obras no terceiro andar do prédio CCH I.' },
      { tag: 'reconhecimento', title: 'Novas Servidoras de Apoio e Aniversário do PET ADM', desc: 'Ata nº 339/2018. 14 de setembro de 2018: O Colegiado registrou a presença das servidoras Ana Paula e Priscila, que passaram a compor a equipe responsável pelo serviço de limpeza e manutenção do departamento. No âmbito das celebrações institucionais, o professor Thiago de Melo Teixeira da Costa destacou a comemoração dos 30 anos de existência do PET ADM no departamento.' },
      { tag: 'ensino', title: 'Representação Estudantil e Novo Curso de Capacitação EaD', desc: 'Ata nº 341/2018. 30 de novembro de 2018: Nesta data, o Colegiado deu as boas-vindas às novas representantes discentes Julia Sabino Carneiro e Bárbara Tavares de Paula, que passaram a integrar as reuniões do departamento. Além disso, foi aprovada a abertura de um novo curso de capacitação profissional na modalidade a distância, intitulado "Gestão de Risco de Contrato no Setor Público", com previsão de início para o primeiro semestre de 2019.' },
  ...
  2020: {
    events: [
      { "tag": "gestao", "title": "Novos Docentes e Inauguração de Auditório", "desc": "Ata 351/2020 – 13 de março de 2020. Na reunião realizada nesta data, o Senhor Presidente deu as boas-vindas aos novos professores do departamento, Ana Cláudia Azevedo e Layon Carlos Cezar. Entre os informes apresentados, destacou-se a inauguração do auditório do CCH1, espaço que passou a ser compartilhado com o DEE. Na mesma ocasião, a professora Tainá Rodrigues Gomide Souza Pinto informou o Colegiado a respeito do início das atividades e das aulas do curso MBA em Gestão Empresarial." },
      { "tag": "ensino", "title": "Aprovação da Pós-Graduação em Administração Pública Municipal", "desc": "Ata 352/2020 – 15 de maio de 2020. Durante a sessão virtual, o Colegiado tratou de assuntos ligados à expansão e formalização de novos cursos na instituição. A professora Suely de Fátima Ramos Silveira comunicou aos presentes que o curso de pós-graduação lato sensu em Administração Pública Municipal foi oficialmente aprovado pela PPG em reunião ocorrida no dia 08 de maio, trazendo ainda a previsão oficial de que as atividades letivas do referido curso tenham início no mês de agosto do mesmo ano." },

      { "tag": "infraestrutura", "title": "Melhorias de Infraestrutura e Planejamento de Medalhas", "desc": "Ata 353/2020 – 10 de julho de 2020. Neste encontro, o Chefe do Departamento apresentou informes detalhados sobre melhorias nas instalações físicas e infraestrutura predial, incluindo a execução das obras de reforma da sala 200, os serviços de limpeza geral e nos gabinetes, além da readequação da matriz orçamentária do departamento para a aquisição de materiais permanentes essenciais, tais como aparelhos de ar-condicionado, computadores e novos monitores destinados ao laboratório de informática. Adicionalmente, foram discutidas as indicações de docentes e servidores técnico-administrativos para o recebimento da Medalha do Mérito da UFV nas áreas de Ensino, Pesquisa, Extensão e Administrativo, ficando acordado que as comissões internas se organizariam para formalizar as propostas de homenagem no próximo ano." },

      { "tag": "infraestrutura", "title": "Atualizações Estruturais e Professores Substitutos", "desc": "Ata 354/2020 – 07 de agosto de 2020. Na reunião de Colegiado deste dia, o Senhor Presidente trouxe atualizações sobre as instalações físicas do departamento, reportando o andamento do uso das dependências do DAD e o processo de compra dos aparelhos de ar-condicionado para o local. No âmbito das discussões sobre o corpo docente, o presidente registrou agradecimentos oficiais pelo apoio prestado e informou a manutenção das atividades dos professores substitutos Gustavo Leonardo Simão, Monique da Silva Santana e Vinícius Mendes França no departamento." },

      { "tag": "ensino", "title": "Reformulação Curricular e Plano para Centro Acadêmico", "desc": "Ata 355/2020 – 11 de setembro de 2020. Em continuidade às melhorias e reestruturações do departamento, o coordenador do curso de Ciências Contábeis, professor Antônio Carlos Brunozi Júnior, apresentou uma proposta de reformulação aprovada por unanimidade que adicionou novas disciplinas obrigatórias e permitiu a criação de novas disciplinas optativas na matriz curricular. Logo após, o representante discente do curso de Administração, Gabriel Sunsi Almada de Abreu, expôs perante o Colegiado um plano estruturado em três fases distintas que visa o engajamento estudantil para culminar na criação do Centro Acadêmico (C.A.) do curso de Administração após o período da pandemia." },

      { "tag": "gestao", "title": "Resultado de Processo Seletivo de Redistribuição", "desc": "Ata 356/2020 – 09 de outubro de 2020. Anúncio oficial do resultado final do processo seletivo de redistribuição de vagas para o DAD, com a aprovação em primeiro lugar do candidato Leandro Rivelli Teixeira Nogueira para o quadro docente." },

      { "tag": "gestao", "title": "Premiações, Movimentação de Pessoal e Mudança do PET", "desc": "Ata 357/2020 – 13 de novembro de 2020. O Senhor Presidente parabenizou publicamente o professor Magnus Luiz Emmendoerfer pelo encerramento de seu mandato e excelente trabalho na Sociedade Brasileira de Administração Pública, além de estender as homenagens ao professor Alan Ferreira de Freitas e ao pós-graduando Samuel Soares da Silva pelo prêmio de melhor artigo recebido. Na mesma reunião, foram prestados agradecimentos dedicados aos professores substitutos Gustavo Leonardo Simão, por sua aprovação em concurso na UFES, e Monique da Silva Santana, pelo encerramento de seu contrato e dedicação ao DAD, além de ser anunciada a abertura de um novo concurso para professor substituto na vaga da professora Mariana de Freitas Coelho. Por fim, foram trazidos informes sobre novas apresentações de cursos e o convite da professora Simone Martins para o lançamento de livro, enquanto o representante dos técnico-administrativos comunicou a mudança física do PET para o terceiro andar do prédio do CCH1." },

      { "tag": "infraestrutura", "title": "Planejamento de Final de Ano e Alocação de Docentes", "desc": "Ata 358/2020 – 11 de dezembro de 2020. Na última reunião do ano, o Senhor Presidente abordou temas de infraestrutura e planejamento do corpo docente. Em seus informes iniciais, comunicou a aquisição de 10 novos computadores para equipar o laboratório, confirmou a mudança física das instalações do PET para o terceiro andar do prédio do CCH1 e detalhou as ações de preparação dos gabinetes físicos que serão destinados a receber os novos professores. Encerrando a pauta, o coordenador do curso de Ciências Contábeis ressaltou que tanto os novos professores quanto o professor substituto que ocupará a vaga da professora Mariana de Freitas Coelho já foram devidamente incluídos no planejamento e na planilha de disciplinas da instituição." },
