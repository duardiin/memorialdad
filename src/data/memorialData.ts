...
export const memorialData: MemorialData = {
  ...
  2021: {
    events: [
      ...
      { "tag": "infraestrutura", "title": "Boas Vindas de Docentes", "desc": "Ata 362/2021 – 07 de maio de 2021. Ficou registrado as boas-vindas do Colegiado ao professor Leandro Rivelli Teixeira Nogueira." },

      { tag: 'reconhecimento', title: 'Despedida do Prof. Walmer Faroni X', desc: 'Definiu-se no cronograma de eventos que a homenagem oficial do departamento ao professor Walmer Faroni, em reconhecimento aos seus relevantes serviços prestados ao DAD após decisão de não renovar vínculo voluntário. X' },
  ...
  2023: {
    events: [
      ...
      { "tag": "gestao", "title": "Galeria dos Chefes e Sucesso do ReceptiviDAD", "desc": "Ata 387/2023 (19 de maio de 2023). Durante a discussão, sugeriu-se a implementação de uma galeria virtual contendo o histórico e as biografias dos ex-chefes no site oficial do DAD, além da confecção de um álbum físico de fotografias como registro de recordação." },


      { "tag": "extensao", "title": "Lançamento de Livro", "desc": "Ata 391/2023 (20 de outubro de 2023). Lançamento oficial do livro intitulado “A Universidade e o Envelhecimento Populacional: Diálogos e Experiências em Construção no Brasil”." },
  ...
  2024: {
    events: [
      ...
      { "tag": "gestao", "title": "Homenagem da SBAP ", "desc": "Ata 396/2024 – 12 de julho de 2024. Nesta reunião, o departamento registrou uma homenagem conferida pela Sociedade Brasileira de Administração Pública, que agraciou o Programa de Pós-Graduação em Administração pelos relevantes serviços prestados. " },

      { "tag": "infraestrutura", "title": "Menção de Inovação do NIT e Orçamentos de Infraestrutura", "desc": "Ata 399/2024 – 06 de dezembro de 2024. Na última reunião do ano, o departamento celebrou o recebimento de uma menção de Difusão da Cultura de Proteção da Propriedade Intelectual e Inovação, concedida ao DAD durante a comemoração dos 25 anos do Núcleo de Inovação Tecnológica (NIT/UFV). " },
